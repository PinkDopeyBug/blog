...
![[Pasted image 20240505135204.png]]
```
/**
 * 单例模式-饿汉
 *
...
## 简单工厂模式
![[Pasted image 20240421171821.png]]
...
也是通过父类指针控制子类行为
![[Pasted image 20240505135332.png]]
```
#include <iostream>
using namespace std;
...
最后再由主工厂类将这些零部件组合起来
![[Pasted image 20240505135401.png]]
...
对于客户端代码来说， 主管类完全隐藏了产品构造细节。 客户端只需要将一个生成器与主管类关联， 然后使用主管类来构造产
![[Pasted image 20240505135530.png]]品， 就能从生成器处获得构造结果了。
...
![[Pasted image 20240505135551.png]]
```
#include <iostream>
using namespace std;
