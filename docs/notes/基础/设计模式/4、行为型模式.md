...
![[Pasted image 20240504210411.png]]
```
...
![[Pasted image 20240504213817.png]]
```
#include <iostream>
#include <map>
using namespace std;
...
![[Pasted image 20240504222838.png]]
...
![[Pasted image 20240504224545.png]]
...
![[Pasted image 20240505103359.png]]
...
![[Pasted image 20240505111040.png]]
...
![[Pasted image 20240505122914.png]]
```
// 抽象的策略类
...
状态模式和策略模式比较类似，策略模式中的各个策略是独立的不关联的，但是状态模式下的对象的各种状态可以是独立的也可以是相![[Pasted image 20240505125349.png]]互依赖的，
...
模板方法这种设计模式是对多态的典型应![[Pasted image 20240505130934.png]]用。
...
![[Pasted image 20240505133737.png]]
```
// 抽象的成员类
