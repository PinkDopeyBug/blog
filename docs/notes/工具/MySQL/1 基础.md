...
#### 数值类型
![[c6aa6626cefc4afa6c608eadae60c81 1.jpg]]
如果需要给数据类型指定为无符号类型要在数据类型后面加unsigned如：
age int unsigned

#### 字符串类型
![[1318ea1e590fadee900a06324b387dd.jpg]]
char效率较高，varchar效率较低
varchar类型会根据当前字符串内容确定需要分配的存储空间，自然效率较低但是存储利用率高

#### 日期类型
![[c9279fe4d151d5f78c2974e89ec2618.jpg]]
...
```
条件列表：
![[Pasted image 20240305190137.png]]
示例：
在emp表中查询age为88的员工信息
```
...
## DQL语句执行顺序
![[Pasted image 20240305202428.png]]
表中循序是编写顺序
序号是执行顺序
